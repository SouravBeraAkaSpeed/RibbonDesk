...
export default function TermsPage() {
  return <LegalPage eyebrow="Beta terms" title="Use RibbonDesk responsibly" updated="August 31, 2026" sections={[
    ...
    { title: 'Your responsibility', paragraphs: ['You are responsible for reviewing requirements, citations, deadlines, prepared packets, recipient details, and outgoing messages before approval. Do not upload content you lack permission to use or attempt to access another organization.'] },
